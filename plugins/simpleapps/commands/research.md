...
allowed-tools: Bash(git -C:*), Skill(wiki), Skill(project-defaults), Skill(augur-packages), Skill(git-safety), Skill(bash-simplicity), Read, Write, Glob, Grep, Edit, Agent, WebSearch, WebFetch
---
